...
class RandomPosMaskingEsmGenerator(BaseSmartMaskingEsmGenerator):
    ...
    def __str__(self):
        return f"random_pos_{super().__str__()}"
...
class RelDiffMaskingEsmGenerator(BaseSmartMaskingEsmGenerator):
    def _get_score_and_token_choice(self, probs: Tensor, position: int, original_aa: str):
        ...
        score, aa_choice = self._get_feasible_token_with_max_score(original_aa, scores, amino_acids)
        return score, aa_choice
