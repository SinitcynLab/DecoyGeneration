...
#SBATCH --job-name=mlp_crap_3_%j
#SBATCH --output=mlp_crap_3_%j.txt
...
#python -u src/decoy_gen.py --command generate --generators smart_masking_esm --target_file data/targets/crap.fasta --output_directory data/targets