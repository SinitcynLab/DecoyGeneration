...
*Generate decoys from UP000002311_559292.fasta using the ESM-based generator with 650M parameters at a parameter precision of 32 bits*:
...
In order to install the models used in this codebase, navigate to the root directory and run:

python src/io/download_models.py

Running this command will isntall the 'prot_bert' model and various ESM-2 versions.