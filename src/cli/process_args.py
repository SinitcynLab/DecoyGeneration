...
from src.decoy_generators.smart_masking_esm import MaxProbMaskingEsmGenerator, RelDiffMaskingEsmGenerator, RandomPosMaskingEsmGenerator
...
def create_generator_from_string(generator_string: str, seed: int, mask_count: int, device: torch.device = None):
    ...
    elif generator_string == "random_smart_esm":
        generator = RandomPosMaskingEsmGenerator(
            local_path="models/esm2_t6_8M_UR50D",
            random=random,
            special_amino_acids=special_amino_acids,
            sort_optimization=True,
