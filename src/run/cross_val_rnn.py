...
if __name__ == "__main__":
    ...
    decoy_files = [f'data/decoys/{base}.esm3B.best.c1.0.fasta', f'data/decoys/{base}.esm150M.best.c1.0.fasta', f'data/decoys/{base}.esm35M.best.c1.0.fasta']
    decoy_ids = ['esm_3B_c1', 'esm_150M_c1', 'esm_35M_c1']
